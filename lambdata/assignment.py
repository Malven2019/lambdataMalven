...
def add_state_names_columns(my_df):
    ...
    Params(my_df) a DataFrame with a column called 'abbrev' that
    has state abbreviations
    Return a copy of the original DataFrame but with an extra column
    """
    new_df = my_df.copy()
    names_map = {'CA': 'Cali', 'CO': 'Colo', 'CT': 'Conn'}
    # see this link; https://pandas.pydata.org/pandas-docs/
    # stable/reference/api/pandas.Series.map.html
